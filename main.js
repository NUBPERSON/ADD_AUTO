...
let urlqw="https://www.hackerrank.com";
async function run() {
    // start the browser
    ...
    await page.type("input[name='username']", "jaivinsphogaat@gmail.com", { delay: 20 });

    // type password
    await page.waitForSelector("input[name='password']");
    await page.type("input[name='password']", "automation", { delay: 20 });
...
async function handleAllContestsOfAPage(page, browser) {
    ...
    for (let i = 0; i < curls.length; i++) {
        ...
        console.log(urlqw+curls[i] );
        await saveModeratorInContest(ctab, urlqw+curls[i] ,"navdeep_usict");
